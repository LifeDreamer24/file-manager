...
<?php else: ?>
  <main class="home-shell">
      ...
      <div class="home-hero-copy">
        ...
        <div class="home-hero-actions">
          <a class="home-button home-button-primary" href="<?= htmlspecialchars($loginUrl, ENT_QUOTES, 'UTF-8') ?>" data-page-transition>
            Open file manager <svg class="home-button-arrow" viewBox="0 0 20 20" width="18" height="18" fill="none" aria-hidden="true"><path d="M4.5 10h10.75m-4.25-4.25L15.25 10 11 14.25" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg>
          </a>
          <a class="home-button home-button-secondary" href="https://github.com/LifeDreamer24/file-manager" target="_blank" rel="noopener noreferrer">View on GitHub <svg viewBox="0 0 16 16" width="18" height="18" fill="currentColor" aria-hidden="true"><path d="M8 0C3.58 0 0 3.64 0 8.13c0 3.59 2.29 6.64 5.47 7.72.4.08.55-.18.55-.39 0-.19-.01-.83-.01-1.51-2.01.38-2.53-.5-2.69-.96-.09-.23-.48-.96-.82-1.15-.28-.15-.68-.53-.01-.54.63-.01 1.08.59 1.23.83.72 1.23 1.87.88 2.33.67.07-.53.28-.88.51-1.08-1.78-.21-3.64-.91-3.64-4.02 0-.89.31-1.62.82-2.19-.08-.21-.36-1.04.08-2.16 0 0 .67-.22 2.2.84A7.46 7.46 0 0 1 8 3.94c.68 0 1.36.09 2 .27 1.53-1.06 2.2-.84 2.2-.84.44 1.12.16 1.95.08 2.16.51.57.82 1.3.82 2.19 0 3.12-1.87 3.81-3.65 4.02.29.25.54.74.54 1.51 0 1.09-.01 1.97-.01 2.24 0 .22.15.47.55.39A8.15 8.15 0 0 0 16 8.13C16 3.64 12.42 0 8 0Z"/></svg></a>
        </div>
    ...
    <section class="home-cta">
      ...
      <a class="home-button home-button-primary" href="<?= htmlspecialchars($loginUrl, ENT_QUOTES, 'UTF-8') ?>" data-page-transition>Log in <svg class="home-button-arrow" viewBox="0 0 20 20" width="18" height="18" fill="none" aria-hidden="true"><path d="M4.5 10h10.75m-4.25-4.25L15.25 10 11 14.25" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></a>
    </section>
